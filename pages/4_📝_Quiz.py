...
from utils.helpers import get_grade, get_performance_emoji, render_sidebar, inject_custom_css, require_login, play_correct_sound, play_wrong_sound, celebrate_confetti
...
# ── QUIZ MODE ───────────────────────────────────────────────
    ...
    if st.session_state.qz_submitted:
        ...
        if pct == 100 and total > 0:
            celebrate_confetti("🎉", 5)
            st.success("🎉 PERFECT SCORE! You got every question right!")
